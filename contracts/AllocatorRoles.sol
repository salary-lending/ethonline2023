...
contract AllocatorRoles {
    ...
    mapping(bytes32 => mapping(address => mapping(bytes4 => bytes32)))
        public actionsRoles;
    ...
    modifier ilkAuth(bytes32 ilk) {
        require(
            ilkAdmins[ilk] == msg.sender,
            "AllocatorRoles/ilk-not-authorized"
        );
        _;
    }
    ...
    function canCall(
        ...
        ok =
            userRoles[ilk][caller] & actionsRoles[ilk][target][sig] !=
            bytes32(0);
    }
}
